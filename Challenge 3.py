...
for letter in text[4:-4]:
    if letter.islower():
        if text[count-3:count].isupper() and text[count+1:count+4].isupper() and text[count-4].islower() and text[count+4].islower():
            print(text[count-4:count+5])
            answer += letter
    count += 1
